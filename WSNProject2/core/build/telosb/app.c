...
} __attribute__((packed)) int_msg_t;
...
typedef nx_struct seq_msg_t {
  nx_uint16_t sequence_number;
} __attribute__((packed)) seq_msg_t;
...
typedef TMilli AggregationCoreC__Timer3__precision_tag;
typedef TMilli AggregationCoreC__Timer1__precision_tag;
typedef TMilli AggregationCoreC__Timer2__precision_tag;
...
static void AggregationCoreC__Boot__booted(void );
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void AggregationCoreC__Timer3__fired(void );
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void AggregationCoreC__AMSend__sendDone(
#line 92
message_t * msg, 
...
static void AggregationCoreC__askForLackData__runTask(void );
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void AggregationCoreC__Timer1__fired(void );
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void AggregationCoreC__sendResult__runTask(void );
...
AggregationCoreC__Receive__receive(
#line 60
message_t * msg, 
void * payload, 
...
static void AggregationCoreC__Control__startDone(error_t error);
#line 117
static void AggregationCoreC__Control__stopDone(error_t error);
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void AggregationCoreC__Timer2__fired(void );
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void AggregationCoreC__request__runTask(void );
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
/*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static void /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 85
message_t * msg, 
...
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void AggregationCoreC__Timer3__startPeriodic(uint32_t dt);
...
AggregationCoreC__Packet__getPayload(
#line 110
message_t * msg, 
...
uint8_t len);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t AggregationCoreC__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
AggregationCoreC__AMSend__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t AggregationCoreC__askForLackData__postTask(void );
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void AggregationCoreC__Timer1__startPeriodic(uint32_t dt);
#line 67
static void AggregationCoreC__Timer1__stop(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t AggregationCoreC__sendResult__postTask(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
static void AggregationCoreC__Leds__led0Toggle(void );
#line 72
static void AggregationCoreC__Leds__led1Toggle(void );
#line 89
static void AggregationCoreC__Leds__led2Toggle(void );
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static error_t AggregationCoreC__Control__start(void );
#line 109
static error_t AggregationCoreC__Control__stop(void );
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void AggregationCoreC__Timer2__startPeriodic(uint32_t dt);
#line 67
static void AggregationCoreC__Timer2__stop(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t AggregationCoreC__request__postTask(void );
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static am_addr_t AggregationCoreC__AMPacket__source(
#line 73
message_t * amsg);
# 60 "AggregationCoreC.nc"
enum AggregationCoreC____nesc_unnamed4313 {
#line 60
  AggregationCoreC__sendResult = 0U
};
#line 60
typedef int AggregationCoreC____nesc_sillytask_sendResult[AggregationCoreC__sendResult];
#line 79
enum AggregationCoreC____nesc_unnamed4314 {
#line 79
  AggregationCoreC__askForLackData = 1U
};
#line 79
typedef int AggregationCoreC____nesc_sillytask_askForLackData[AggregationCoreC__askForLackData];
#line 112
enum AggregationCoreC____nesc_unnamed4315 {
#line 112
  AggregationCoreC__request = 2U
};
#line 112
typedef int AggregationCoreC____nesc_sillytask_request[AggregationCoreC__request];
#line 21
message_t AggregationCoreC__sendBuf;
result_msg_t AggregationCoreC__result;
uint16_t AggregationCoreC__data[N_RANDOM_NUMBER];

uint16_t AggregationCoreC__seq = 0;

uint16_t AggregationCoreC__lackSeqs[N_RANDOM_NUMBER - REQUEST_THRESHOLD];

uint16_t AggregationCoreC__nReceived;
bool AggregationCoreC__busy = FALSE;
bool AggregationCoreC__received[N_RANDOM_NUMBER];


bool AggregationCoreC__readyToSendResult = FALSE;


bool AggregationCoreC__readyToRequest = FALSE;

bool AggregationCoreC__isAsking = FALSE;

int AggregationCoreC__nToRequest;

int AggregationCoreC__curIndexToRequest;
int AggregationCoreC__i;

static inline void AggregationCoreC__Boot__booted(void );
#line 60
static inline void AggregationCoreC__sendResult__runTask(void );
...
static inline void AggregationCoreC__Control__startDone(error_t err);
...
static inline void AggregationCoreC__Control__stopDone(error_t err);



static inline void AggregationCoreC__askForLackData__runTask(void );
#line 100
static void AggregationCoreC__AMSend__sendDone(message_t *msg, error_t error);
#line 112
static inline void AggregationCoreC__request__runTask(void );
#line 141
int AggregationCoreC__tmp;
static inline int AggregationCoreC__partition(int a[], int low, int high);
#line 163
static int AggregationCoreC__findk(int a[], int low, int high, int k);
#line 179
static inline void AggregationCoreC__calculate(void );
#line 208
static inline void AggregationCoreC__Timer1__fired(void );
#line 223
static inline void AggregationCoreC__Timer2__fired(void );





static inline void AggregationCoreC__Timer3__fired(void );





static inline message_t *AggregationCoreC__Receive__receive(message_t *msg, void *payload, uint8_t len);
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
...
enum /*CounterMilli32C.Transform*/TransformCounterC__0____nesc_unnamed4346 {
...
enum /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC__0____nesc_unnamed4347 {
...
message_t *msg);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 56
message_t * msg, 
...
/*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__getPayload(
#line 111
message_t * msg, 
...
uint8_t len);
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static void /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/opt/tinyos-2.x/tos/system/AMQueueEntryP.nc"
static error_t /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
...
static inline void */*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__getPayload(message_t *m, uint8_t len);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
# 28 "/opt/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x406cd428){
#line 28
  switch (arg_0x406cd428) {
#line 28
    case 0:
#line 28
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x406cd428);
#line 28
      break;
#line 28
    }
...
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0x40b06cf8){
#line 55
  switch (arg_0x40b06cf8) {
#line 55
...
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__unconfigure(arg_0x40b06cf8);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x40f0f030){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  switch (arg_0x40f0f030) {
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x40f0f030);
#line 110
      break;
#line 110
    }
...
# 88 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x4123e598, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x4123e598, msg);
#line 88
}
#line 88
...
# 118 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x40f0f030){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x40f0f030);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x40f0fa80){
#line 39
  union __nesc_unnamed4284 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x40f0fa80);
#line 39
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x40b06cf8){
#line 49
  switch (arg_0x40b06cf8) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0x40b06cf8);
#line 49
      break;
#line 49
    }
...
# 51 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__immediateRequested(uint8_t arg_0x40b07948){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__immediateRequested(arg_0x40b07948);
#line 51
}
#line 51
...
# 87 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x40f0f030){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x40f0f030);
#line 87
      break;
#line 87
    }
...
# 43 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__requested(uint8_t arg_0x40b07948){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__requested(arg_0x40b07948);
#line 43
}
#line 43
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x40f0f030){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x40f0f030);
#line 78
      break;
#line 78
    }
...
#line 54
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  AggregationCoreC__AMSend__sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__sendDone(uint8_t arg_0x40b88c90, message_t * msg, error_t error){
#line 89
  switch (arg_0x40b88c90) {
#line 89
    case 0U:
#line 89
      /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__default__sendDone(arg_0x40b88c90, msg, error);
#line 89
      break;
#line 89
    }
...
#line 56
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__send(am_id_t arg_0x40b85730, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x40b85730, addr, msg, len);
#line 69
...
# 59 "/opt/tinyos-2.x/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x4123fef8, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x4123fef8, dest, msg);
#line 59
}
#line 59
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x4123e598, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x4123e598, msg);
#line 95
}
#line 95
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x41206a98){
#line 92
  switch (arg_0x41206a98) {
#line 92
...
#line 92
    default:
#line 92
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x41206a98);
#line 92
      break;
#line 92
    }
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x412404e0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x412404e0, msg, payload, len);
#line 67
...
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void AggregationCoreC__Timer3__startPeriodic(uint32_t dt){
#line 53
...
inline static error_t AggregationCoreC__Control__stop(void ){
#line 109
  unsigned char __nesc_result;
#line 109
...
inline static void AggregationCoreC__Timer2__stop(void ){
#line 67
...
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static am_addr_t AggregationCoreC__AMPacket__source(message_t * amsg){
#line 77
  unsigned int __nesc_result;
#line 77
...
inline static void AggregationCoreC__Leds__led2Toggle(void ){
#line 89
  LedsP__Leds__led2Toggle();
#line 89
}
#line 89
# 235 "AggregationCoreC.nc"
static inline message_t *AggregationCoreC__Receive__receive(message_t *msg, void *payload, uint8_t len)
#line 235
{

  if (len == sizeof(int_msg_t ) && !AggregationCoreC__readyToSendResult) {
      int_msg_t *recv_pkt = (int_msg_t *)payload;

#line 239
      AggregationCoreC__seq = __nesc_ntoh_uint16(recv_pkt->sequence_number.data) - 1;
      if (AggregationCoreC__received[AggregationCoreC__seq] == FALSE) {
          AggregationCoreC__received[AggregationCoreC__seq] = TRUE;
          AggregationCoreC__data[AggregationCoreC__seq] = (uint16_t )__nesc_ntoh_uint32(recv_pkt->random_integer.data);
          AggregationCoreC__nReceived++;
          AggregationCoreC__Leds__led2Toggle();
        }
    }
  else {
    if (len == sizeof(ack_msg_t ) && AggregationCoreC__AMPacket__source(msg) == 0) {
        ack_msg_t *recv_pkt = (ack_msg_t *)payload;

#line 250
        if (__nesc_ntoh_uint8(recv_pkt->group_id.data) == GROUP_ID) {
            AggregationCoreC__Timer2__stop();
            AggregationCoreC__Control__stop();

            AggregationCoreC__Timer3__startPeriodic(1000);
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x41242e38, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x41242e38) {
#line 67
    case 0:
#line 67
      __nesc_result = AggregationCoreC__Receive__receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x41242e38, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x40f12230){
#line 92
  switch (arg_0x40f12230) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x40f12230);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0x40b0ae70){
#line 92
  switch (arg_0x40b0ae70) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0x40b0ae70);
#line 92
      break;
#line 92
    }
...
# 71 "/opt/tinyos-2.x/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x40f10820, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x40f10820) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x40f10820, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 71 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x40ed27d8, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40ed27d8) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x40ed27d8, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x4123e598, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x4123e598, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x40ed27d8, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40ed27d8) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x40ed27d8, data, length, error);
#line 91
      break;
#line 91
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x40ea0d90){
#line 92
  switch (arg_0x40ea0d90) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP__Resource__default__granted(arg_0x40ea0d90);
#line 92
      break;
#line 92
    }
...
#line 89
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x41242478, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__sendDone(arg_0x41242478, msg, error);
#line 99
}
#line 99
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
#line 89
# 241 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline void CC2420CsmaP__sendDone_task__runTask(void )
#line 241
{
  error_t packetErr;
...
#line 117
  AggregationCoreC__Control__stopDone(error);
#line 117
}
#line 117
...
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
inline static error_t AggregationCoreC__Control__start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
#line 83
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void AggregationCoreC__Timer1__startPeriodic(uint32_t dt){
#line 53
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startPeriodic(0U, dt);
#line 53
}
#line 53
# 67 "AggregationCoreC.nc"
static inline void AggregationCoreC__Control__startDone(error_t err)
#line 67
{
  if (err == SUCCESS) {
      AggregationCoreC__Timer1__startPeriodic(200);
    }
  else 
#line 70
    {
      AggregationCoreC__Control__start();
    }
}
...
#line 92
  AggregationCoreC__Control__startDone(error);
#line 92
}
#line 92
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t AggregationCoreC__request__postTask(void ){
#line 56
  unsigned char __nesc_result;
#line 56

#line 56
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(AggregationCoreC__request);
#line 56
...
#line 56
inline static error_t AggregationCoreC__sendResult__postTask(void ){
#line 56
  unsigned char __nesc_result;
#line 56

#line 56
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(AggregationCoreC__sendResult);
#line 56
...
#line 56
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void AggregationCoreC__Timer2__startPeriodic(uint32_t dt){
#line 53
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startPeriodic(1U, dt);
#line 53
}
#line 53
# 179 "AggregationCoreC.nc"
static inline void AggregationCoreC__calculate(void )
#line 179
{
...
#line 181
  int q = AggregationCoreC__findk(AggregationCoreC__data, 0, N_RANDOM_NUMBER - 1, N_RANDOM_NUMBER / 2 + 1);

#line 182
  printf("enter calculate\n");
  __nesc_hton_uint32(AggregationCoreC__result.median.data, AggregationCoreC__data[q]);
  __nesc_hton_uint32(AggregationCoreC__result.min.data, AggregationCoreC__data[q]);
  __nesc_hton_uint32(AggregationCoreC__result.max.data, 0);

  for (AggregationCoreC__i = 0; AggregationCoreC__i < q; AggregationCoreC__i++) {
      if (AggregationCoreC__data[AggregationCoreC__i] > __nesc_ntoh_uint32(AggregationCoreC__result.max.data)) {
          __nesc_hton_uint32(AggregationCoreC__result.max.data, AggregationCoreC__data[AggregationCoreC__i]);
        }
      else {
#line 190
        if (AggregationCoreC__data[AggregationCoreC__i] < __nesc_ntoh_uint32(AggregationCoreC__result.min.data)) {
            __nesc_hton_uint32(AggregationCoreC__result.min.data, AggregationCoreC__data[AggregationCoreC__i]);
          }
        }
#line 193
      (__nesc_temp42 = AggregationCoreC__result.sum.data, __nesc_hton_uint32(__nesc_temp42, __nesc_ntoh_uint32(__nesc_temp42) + AggregationCoreC__data[AggregationCoreC__i]));
    }

  __nesc_hton_uint32(AggregationCoreC__result.median.data, (__nesc_ntoh_uint32(AggregationCoreC__result.median.data) + __nesc_ntoh_uint32(AggregationCoreC__result.max.data)) / 2);

  for (AggregationCoreC__i = q; AggregationCoreC__i < N_RANDOM_NUMBER; AggregationCoreC__i++) {
      if (AggregationCoreC__data[AggregationCoreC__i] > __nesc_ntoh_uint32(AggregationCoreC__result.max.data)) {
          __nesc_hton_uint32(AggregationCoreC__result.max.data, AggregationCoreC__data[AggregationCoreC__i]);
        }
      (__nesc_temp43 = AggregationCoreC__result.sum.data, __nesc_hton_uint32(__nesc_temp43, __nesc_ntoh_uint32(__nesc_temp43) + AggregationCoreC__data[AggregationCoreC__i]));
    }
  __nesc_hton_uint32(AggregationCoreC__result.average.data, __nesc_ntoh_uint32(AggregationCoreC__result.sum.data) / N_RANDOM_NUMBER);
  printf("leave calculate\n");
}

# 67 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void AggregationCoreC__Timer1__stop(void ){
#line 67
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__stop(0U);
#line 67
}
#line 67
# 208 "AggregationCoreC.nc"
static inline void AggregationCoreC__Timer1__fired(void )
#line 208
{
  if (AggregationCoreC__nReceived == N_RANDOM_NUMBER) {
      AggregationCoreC__Timer1__stop();
      AggregationCoreC__calculate();
      if (AggregationCoreC__readyToSendResult == FALSE) {
          AggregationCoreC__readyToSendResult = TRUE;
          AggregationCoreC__Timer2__startPeriodic(10);
        }
      AggregationCoreC__sendResult__postTask();
    }
  else {
#line 217
    if (AggregationCoreC__nReceived >= REQUEST_THRESHOLD) {
        AggregationCoreC__request__postTask();
      }
    }
#line 220
  printf("seq=%u, int=%u nRecv=%u\n", AggregationCoreC__seq, AggregationCoreC__data[AggregationCoreC__seq], AggregationCoreC__nReceived);
}
...
# 56 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
inline static void AggregationCoreC__Leds__led0Toggle(void ){
#line 56
  LedsP__Leds__led0Toggle();
#line 56
}
#line 56
# 223 "AggregationCoreC.nc"
static inline void AggregationCoreC__Timer2__fired(void )
#line 223
{
  AggregationCoreC__Leds__led0Toggle();
  AggregationCoreC__sendResult__postTask();
}
...
inline static void AggregationCoreC__Leds__led1Toggle(void ){
#line 72
  LedsP__Leds__led1Toggle();
#line 72
}
#line 72
# 229 "AggregationCoreC.nc"
static inline void AggregationCoreC__Timer3__fired(void )
#line 229
{
  AggregationCoreC__Leds__led0Toggle();
  AggregationCoreC__Leds__led1Toggle();
  AggregationCoreC__Leds__led2Toggle();
}
...
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x40c7a030){
#line 72
  switch (arg_0x40c7a030) {
#line 72
    case 0U:
#line 72
      AggregationCoreC__Timer1__fired();
#line 72
      break;
#line 72
    case 1U:
#line 72
      AggregationCoreC__Timer2__fired();
#line 72
      break;
#line 72
    case 2U:
#line 72
      AggregationCoreC__Timer3__fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x40c7a030);
#line 72
      break;
#line 72
    }
  ...
  while (j_ < high) 
    {
      if (a[j_] >= a[high]) 
        {
          AggregationCoreC__tmp = a[j_];
          a[j_] = a[j_ + 1];
          a[j_ + 1] = AggregationCoreC__tmp;
          i_++;
        }
      j_++;
    }
  AggregationCoreC__tmp = a[high];
  a[high] = a[i_ + 1];
  a[i_ + 1] = AggregationCoreC__tmp;
  return i_ + 1;
}
...
#line 151
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x40b85730, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__send(arg_0x40b85730, addr, msg, len);
#line 69
...
# 23 "/opt/tinyos-2.x/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__dataLinkLength(uart_id_t arg_0x40832398, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  switch (arg_0x40832398) {
#line 23
...
#line 23
    default:
#line 23
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__dataLinkLength(arg_0x40832398, msg, upperLen);
#line 23
      break;
#line 23
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0x40832398){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0x40832398);
#line 15
      break;
#line 15
    }
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x40b88c90, message_t * msg, error_t error){
#line 89
  switch (arg_0x40b88c90) {
#line 89
    case 0U:
...
#line 89
    default:
#line 89
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x40b88c90, msg, error);
#line 89
      break;
#line 89
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__granted(uint8_t arg_0x408bd880){
#line 92
  switch (arg_0x408bd880) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__default__granted(arg_0x408bd880);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x40b0ae70){
#line 92
  switch (arg_0x40b0ae70) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x40b0ae70);
#line 92
      break;
#line 92
    }
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x40b06cf8){
#line 49
  switch (arg_0x40b06cf8) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x40b06cf8);
#line 49
      break;
#line 49
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0x408d3978){
#line 39
  union __nesc_unnamed4288 *__nesc_result;
#line 39

#line 39
  switch (arg_0x408d3978) {
#line 39
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0x408d3978);
#line 39
      break;
#line 39
    }
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0x40772880, message_t * msg, error_t error){
#line 99
  /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x40772880, msg, error);
#line 99
}
#line 99
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0x40833810, message_t * msg, error_t error){
#line 89
  switch (arg_0x40833810) {
#line 89
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 89
...
#line 89
    default:
#line 89
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0x40833810, msg, error);
#line 89
      break;
#line 89
    }
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0x40783298, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__default__receive(arg_0x40783298, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0x408331d0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x408331d0) {
#line 67
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0x408331d0, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 31 "/opt/tinyos-2.x/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0x40832398, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0x40832398, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x40b06cf8){
#line 55
  switch (arg_0x40b06cf8) {
#line 55
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 55
    default:
#line 55
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x40b06cf8);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__release(uint8_t arg_0x408d5e50){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  switch (arg_0x408d5e50) {
#line 110
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__release(arg_0x408d5e50);
#line 110
      break;
#line 110
    }
...
# 118 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__isOwner(uint8_t arg_0x408d5e50){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__isOwner(arg_0x408d5e50);
#line 118
      break;
#line 118
    }
...
# 46 "AggregationCoreC.nc"
static inline void AggregationCoreC__Boot__booted(void )
#line 46
{
  AggregationCoreC__nReceived = 0;
  __nesc_hton_uint8(AggregationCoreC__result.group_id.data, GROUP_ID);
  __nesc_hton_uint32(AggregationCoreC__result.max.data, 0);
  __nesc_hton_uint32(AggregationCoreC__result.min.data, 65535);
  __nesc_hton_uint32(AggregationCoreC__result.sum.data, 0);
  __nesc_hton_uint32(AggregationCoreC__result.average.data, 0);
  __nesc_hton_uint32(AggregationCoreC__result.median.data, 0);
  for (AggregationCoreC__i = 0; AggregationCoreC__i < N_RANDOM_NUMBER; ++AggregationCoreC__i) {
      AggregationCoreC__received[AggregationCoreC__i] = FALSE;
    }
  AggregationCoreC__Control__start();
}
...
#line 49
  AggregationCoreC__Boot__booted();
#line 49
}
#line 49
...
# 51 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x40b07948){
#line 51
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x40b07948);
#line 51
}
#line 51
# 90 "/opt/tinyos-2.x/tos/system/ArbiterP.nc"
...
# 87 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__immediateRequest(uint8_t arg_0x408d5e50){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__immediateRequest(arg_0x408d5e50);
#line 87
      break;
#line 87
    }
...
#line 48
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t AggregationCoreC__askForLackData__postTask(void ){
#line 56
  unsigned char __nesc_result;
#line 56

#line 56
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(AggregationCoreC__askForLackData);
#line 56
...
#line 56
# 112 "AggregationCoreC.nc"
static inline void AggregationCoreC__request__runTask(void )
#line 112
{
  printf("enter request\n");

  if (!AggregationCoreC__readyToRequest) {
      AggregationCoreC__readyToRequest = TRUE;

      for (AggregationCoreC__i = 0; AggregationCoreC__i < N_RANDOM_NUMBER; AggregationCoreC__i++) {
          if (AggregationCoreC__received[AggregationCoreC__i] == FALSE) {
              AggregationCoreC__lackSeqs[AggregationCoreC__nToRequest] = AggregationCoreC__i;
              AggregationCoreC__nToRequest++;
            }
        }

      AggregationCoreC__curIndexToRequest = AggregationCoreC__nToRequest - 1;
      AggregationCoreC__isAsking = TRUE;
      AggregationCoreC__askForLackData__postTask();
    }
  else 
#line 128
    {

      while (AggregationCoreC__nToRequest > 0 && AggregationCoreC__received[AggregationCoreC__lackSeqs[AggregationCoreC__nToRequest - 1]] == TRUE) {
          AggregationCoreC__nToRequest--;
        }
      AggregationCoreC__curIndexToRequest = AggregationCoreC__nToRequest - 1;
      if (!AggregationCoreC__isAsking) {
          AggregationCoreC__askForLackData__postTask();
        }
    }
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t AggregationCoreC__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 69
...
# 115 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
inline static void * AggregationCoreC__Packet__getPayload(message_t * msg, uint8_t len){
#line 115
  void *__nesc_result;
#line 115
...
#line 115
# 79 "AggregationCoreC.nc"
static inline void AggregationCoreC__askForLackData__runTask(void )
#line 79
{
  if (!AggregationCoreC__busy) {
      seq_msg_t *this_pkt = (seq_msg_t *)AggregationCoreC__Packet__getPayload(&AggregationCoreC__sendBuf, (void *)0);

#line 82
      AggregationCoreC__Leds__led1Toggle();

      while (AggregationCoreC__curIndexToRequest >= 0 && AggregationCoreC__received[AggregationCoreC__lackSeqs[AggregationCoreC__curIndexToRequest]]) {
          AggregationCoreC__curIndexToRequest--;
        }

      if (AggregationCoreC__curIndexToRequest >= 0) {
          __nesc_hton_uint16(this_pkt->sequence_number.data, AggregationCoreC__lackSeqs[AggregationCoreC__curIndexToRequest] + 1);
          --AggregationCoreC__curIndexToRequest;
          printf("send lack seq: %u\n", __nesc_ntoh_uint16(this_pkt->sequence_number.data));

          if (AggregationCoreC__AMSend__send(AM_BROADCAST_ADDR, &AggregationCoreC__sendBuf, sizeof(seq_msg_t )) == SUCCESS) {
              AggregationCoreC__busy = TRUE;
            }
        }
    }
}
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
# 151 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
...
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
inline static void * /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__getPayload(am_id_t arg_0x40b85730, message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = CC2420ActiveMessageP__AMSend__getPayload(arg_0x40b85730, msg, len);
#line 124
...
# 114 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void * /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__getPayload(message_t * msg, uint8_t len){
#line 114
  void *__nesc_result;
#line 114
...
#line 65
{
  return /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__getPayload(m, len);
}

# 124 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void * AggregationCoreC__AMSend__getPayload(message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__getPayload(msg, len);
#line 124
...
#line 60
{
  uint16_t size = sizeof AggregationCoreC__result;

#line 62
  memcpy(AggregationCoreC__AMSend__getPayload(&AggregationCoreC__sendBuf, size), &AggregationCoreC__result, size);
  AggregationCoreC__AMSend__send(ACK_NODE_ID, &AggregationCoreC__sendBuf, size);
  printf("send result\n");
}
...
# 79 "/opt/tinyos-2.x/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0x408d6a60, uint8_t byte){
#line 79
  switch (arg_0x408d6a60) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0x408d6a60, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0x408d6a60, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x408d6a60) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0x408d6a60, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x40ae2010, uint8_t data){
#line 54
  switch (arg_0x40ae2010) {
#line 54
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x40ae2010, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0x408d6a60, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x408d6a60) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0x408d6a60, buf, len, error);
#line 57
      break;
#line 57
    }
...
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x40ae2010){
#line 49
  switch (arg_0x40ae2010) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x40ae2010);
#line 49
      break;
#line 49
    }
...
# 54 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__rxDone(uint8_t arg_0x40ae2010, uint8_t data){
#line 54
  switch (arg_0x40ae2010) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__rxDone(arg_0x40ae2010, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__I2CInterrupts__fired(uint8_t arg_0x40ae1010){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__I2CInterrupts__default__fired(arg_0x40ae1010);
#line 39
}
#line 39
...
# 49 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__txDone(uint8_t arg_0x40ae2010){
#line 49
  switch (arg_0x40ae2010) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__txDone(arg_0x40ae2010);
#line 49
      break;
#line 49
    }
...
# 28 "/opt/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x406cd428){
#line 28
  switch (arg_0x406cd428) {
#line 28
    case 0:
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x406cd428);
#line 28
      break;
#line 28
    }
...
#line 64
    case AggregationCoreC__sendResult:
#line 64
      AggregationCoreC__sendResult__runTask();
#line 64
      break;
#line 64
    case AggregationCoreC__askForLackData:
#line 64
      AggregationCoreC__askForLackData__runTask();
#line 64
      break;
#line 64
    case AggregationCoreC__request:
#line 64
      AggregationCoreC__request__runTask();
#line 64
      break;
#line 64
    case SerialP__RunTx:
...
#line 64
# 100 "AggregationCoreC.nc"
static void AggregationCoreC__AMSend__sendDone(message_t *msg, error_t error)
#line 100
{
  if (&AggregationCoreC__sendBuf == msg) {
      AggregationCoreC__busy = FALSE;

      if (AggregationCoreC__curIndexToRequest >= 0 && AggregationCoreC__curIndexToRequest > AggregationCoreC__nToRequest - 10) {
          AggregationCoreC__askForLackData__postTask();
        }
      else 
#line 106
        {
          AggregationCoreC__isAsking = FALSE;
        }
    }
}
...
# 163 "AggregationCoreC.nc"
static int AggregationCoreC__findk(int a[], int low, int high, int k)
{
  if (low < high) 
    {
      int q = AggregationCoreC__partition(a, low, high);
...
#line 172
        if (len < k) {
          return AggregationCoreC__findk(a, q + 1, high, k - len);
          }
        else {
#line 175
          return AggregationCoreC__findk(a, low, q - 1, k);
          }
        }
    }
}
...
#line 47
{
  /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 0);
  return /*AggregationCoreAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}
